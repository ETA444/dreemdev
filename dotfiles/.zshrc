...
function zhelp() {
  ...
  echo "  \033[1mcpanel-sync-cryptopandemic\033[0m  \033[0;32mSync cryptopandemic.com from server\033[0m"
  echo "  \033[1mcpanel-sync-datasafari\033[0m  \033[0;32mSync datasafari.dev from server\033[0m"
  echo "  \033[1mcpanel-sync-dreemcorp\033[0m   \033[0;32mSync dreemcorp.com from server\033[0m"
  echo "  \033[1mcpanel-sync-georgedreemer\033[0m \033[0;32mSync georgedreemer.com from server\033[0m"
  echo "  \033[1mcpanel-sync-dreemerxyz\033[0m   \033[0;32mSync dreemer.xyz from server\033[0m"
  echo ""
  echo ""
...
alias cpanel-sync-dreemcorp="~/dev/projects/dreemcorp.com/scripts/cpanel-sync.sh"
alias cpanel-sync-georgedreemer="~/dev/projects/georgedreemer.com/scripts/cpanel-sync.sh"
alias cpanel-sync-dreemerxyz="~/dev/projects/dreemer.xyz/scripts/cpanel-sync.sh"
